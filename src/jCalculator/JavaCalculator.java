...
public class JavaCalculator extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnPoint.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btnPoint.setText(".");
    ...
    private void btnPlusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPlusActionPerformed
        // This gets the text from the Display Text Field and converts it into a Double then it retains what is already in total1:
        String button_text=btnPlus.getText();
        getOperator(button_text);
        //txtDisplay.setText("");// Clears the text Field for the next number
